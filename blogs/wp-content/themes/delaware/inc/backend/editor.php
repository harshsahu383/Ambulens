...
if ( ! function_exists( 'delaware_editor_typography_css' ) ) :
	/**
	 * Get typography CSS base on settings
	 *
	 * @since 1.1.6
	 */
	function delaware_editor_typography_css() {
		$css        = '';
 ...
 *
 */
function delaware_block_editor_styles() {

	wp_enqueue_style( 'delaware-block-editor-style', get_theme_file_uri( '/css/editor-blocks.css' ) );
	wp_enqueue_style( 'delaware-block-editor-fonts', delaware_fonts_url(), array(), '20180831' );
	wp_enqueue_style( 'delaware-block-editor-flaticon', get_template_directory_uri() . '/css/flaticon.css', array(), '1.0.0' );
	wp_add_inline_style( 'delaware-block-editor-style', delaware_editor_typography_css() );
}

add_action( 'enqueue_block_editor_assets', 'delaware_block_editor_styles' );